...
/***/ function(module, exports, __webpack_require__) {
	...
	const Ball = __webpack_require__(2),
	      ...
	      levelUp = new Audio('https://s3-us-west-2.amazonaws.com/pokebounce/LevelUp.mp3'),
	      popBall = new Audio('https://s3-us-west-2.amazonaws.com/pokebounce/BubblePop.mp3'),
	...
	Game.prototype.draw = function(ctx) {
	  ...
	  if (this.initialized) {
	    ...
	    ctx.fillStyle = "#F6D800";
	      if (this.gameWon) {
	        ctx.fillText("YOU WIN!!", 335, 250);
	        ctx.font = "24px Roboto";
	        ctx.fillText("Final Score:   " + this.score, 395, 325);
	        ctx.fillText("Press SPACE to play again", 350, 400);
	        ...
	        if (this.level === 1 && this.pikachu.lives === 5) {
	          ...
	          ctx.font = "32px Roboto";
	          ctx.fillText("Press SPACE to continue", 330, 380);
	          ctx.fillText(this.score, 900, 50);
	        }
	      }
	  }
	...
	Game.prototype.checkCollisions = function() {
	  for (var pika = 0; pika < 1; pika++) {
	    for (var ball = 1; ball < this.allObjects().length; ball++) {
	...
	Game.prototype.checkWin = function (ctx) {
...
/***/ function(module, exports) {
	...
	Util.LEVELS = {
	 ...
	 4: [
	   ...
	   { startX: 800, size: 2, vel: [-2, 2] },
	   { startX: -500, size: 3, vel: [2, 2] },
	   { startX: 1500, size: 3, vel: [-2, 2] },
	   { startX: -1200, size: 4, vel: [-2, 2] },
	 ],
...
/***/ function(module, exports, __webpack_require__) {
	...
	Pikachu.prototype.checkCollisions = function(otherObject) {
	  if (Util.distance(
	    [(this.pos[0] + 45), (this.pos[1] + 60)], otherObject.pos) < this.radius + otherObject.radius
	  ) {
