...
/***/ function(module, exports, __webpack_require__) {
	...
	Game.prototype.splitBall = function(ball) {
	  ...
	  this.addBall({ posX: ball.pos[0], posY: ball.pos[1], vel: [2, -4], size: (ball.size - 1)});
	  this.addBall({ posX: ball.pos[0], posY: ball.pos[1], vel: [-2, -4], size: (ball.size - 1)});
	};
	
	Game.prototype.addBall = function (ball) {
	  this.balls.push(new Ball({ pos: [ball.posX, ball.posY], vel: ball.vel, size: ball.size}));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Lightning.prototype.checkBall = function () {
	  let self = this;
	  console.log(this.pikachu.game.balls);
